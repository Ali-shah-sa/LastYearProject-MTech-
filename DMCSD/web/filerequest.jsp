...
<%
    ...
    String d = request.getParameter("open");
    String dkey=d.replace(" ", "+");
    ...
    try {
        ...
        if (rs.next()) {
            ...
            int i = st1.executeUpdate("INSERT into request(filename, time, mid, mname, statuss, fid, doid, mmail,approve_time,expire_time,dkey) values('" + fname + "','" + time + "','" + mid + "','" + mname + "','waiting','" + fid + "', '" + doid+ "','" + mmail+ "',now(),now(),'"+dkey+"')");
            if (i != 0) {
